...
import com.widedot.to8.gamebuilder.util.PropertiesReader;
...
public class Game {
	...
	public Game(String file) throws Exception {	
			...
			engineAsmBootT2Loader = propertiesReader.get("engine.asm.boot.t2Loader");							
			engineAsmT2Loader = propertiesReader.get("engine.asm.t2Loader");
