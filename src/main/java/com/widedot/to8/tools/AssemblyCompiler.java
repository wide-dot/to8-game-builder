...
import com.widedot.to8.gamebuilder.builder.DynamicContent;
...
public class AssemblyCompiler
{
	...
	public static int compile(String asmFile, String option, int mode, GameMode gm, int page) throws Exception {
		...
		if (mode==BuildDisk.MEGAROM_T2)
			BuildDisk.dynamicContentT2.savePatchLocations(out, gm, page);
		else if (mode==BuildDisk.FLOPPY_DISK)
			BuildDisk.dynamicContentFD.savePatchLocations(out, gm, page);
